...
def display_students(students):
    ...
    for student in students:
        scores_str = ", ".join(str(int(s)) if s.is_integer()
                               else str(s) for s in student["scores"])
        avg = round(calculate_average(student["scores"]), 2)
        print(
            f"{student['name']:<15}{student['id']:<12}{scores_str:<15}{avg:<10}")
    print("-" * 50)
